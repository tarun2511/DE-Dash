        ...
        <>
            ...
            <div className="flex items-center justify-center min-h-screen bg-zinc-50 dark:bg-black text-zinc-900 dark:text-zinc-100">
                <form onSubmit={handleSubmit} className="p-6 rounded-2xl shadow-xl w-full max-w-sm bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-900">
                    ...
                    <div className="mb-4">
                        <label htmlFor="email" className="block text-xs font-bold text-zinc-400 uppercase tracking-wider mb-1">
                            Email
                        </label>
                        <input
                            type="email"
                    ...
                    <div className="mb-6">
                        <label htmlFor="password" className="block text-xs font-bold text-zinc-400 uppercase tracking-wider mb-1">
                            Password
                        </label>
                        <input
                            type="password"
