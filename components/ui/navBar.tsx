...
import { UserStar, Zap } from 'lucide-react';
  ...
  return (
    <nav className="w-full h-16 bg-white dark:bg-black flex">
      ...
      <ul className="flex gap-4 m-6 ml-auto">
        <li>
          <Link href={"/admin-dash"} className="relative group flex items-center justify-center rounded-lg hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-zinc-100 hover:bg-zinc-100 dark:hover:bg-zinc-900 transition-all"><UserStar />
